...
function c67037924.initial_effect(c)
	...
	e1:SetCondition(function (e,tp,eg,ep,ev,re,r,rp)
		return ((e:GetHandler():IsLocation(LOCATION_HAND) and Duel.GetMatchingGroupCount(function(tc)
			...
			end,tp,0,LOCATION_MZONE,nil)>0
			and Duel.GetMatchingGroupCount(function(tc)
				return tc:IsSummonLocation(LOCATION_EXTRA) and tc:IsFaceup()
			end,tp,LOCATION_MZONE,0,nil)==0) or not e:GetHandler():IsLocation(LOCATION_HAND)) and aux.dscon(e,tp,eg,ep,ev,re,r,rp)
	end)
