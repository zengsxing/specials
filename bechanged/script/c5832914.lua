...
function c5832914.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(5832914,0))
	e4:SetType(EFFECT_TYPE_SINGLE)
	e4:SetCode(EFFECT_TRAP_ACT_IN_HAND)
	e4:SetCondition(c5832914.handcon)
	c:RegisterEffect(e4)
end
function c5832914.filter(c)
	return c:IsFaceup() and c:IsCode(15259703)
end
function c5832914.handcon(e)
	return Duel.IsExistingMatchingCard(c5832914.filter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end
