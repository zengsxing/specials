...
function c96433300.initial_effect(c)
	...
	e1:SetCondition(function (e)
		...
		return (not Duel.IsExistingMatchingCard(function (tc) return not tc:IsRace(RACE_REPTILE) end,tp,LOCATION_GRAVE,0,1,nil) and e:GetHandler():IsLocation(LOCATION_HAND)) or not e:GetHandler():IsLocation(LOCATION_HAND)
	end)
	c:RegisterEffect(e1)
	--special summon
