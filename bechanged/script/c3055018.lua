...
function s.initial_effect(c)
	...
	e1:SetTarget(c3055018.thtg)
	e1:SetOperation(c3055018.activate)
	c:RegisterEffect(e1)
	--race
...
function c3055018.thfilter(c)
	return c:IsRace(RACE_PYRO) and c:IsAttribute(ATTRIBUTE_DARK) and c:IsLevelAbove(5)
		and c:IsAbleToHand()
end
function c3055018.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c3055018.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c3055018.activate(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetMatchingGroup(c3055018.thfilter,tp,LOCATION_DECK,0,nil)
	...
	e2:SetTarget(c3055018.limit1)
	e2:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e2,tp)
end
function c3055018.limit1(e,c)
