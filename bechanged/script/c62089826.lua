...
function c62089826.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(62089826,4))
	e5:SetType(EFFECT_TYPE_SINGLE)
	e5:SetCode(EFFECT_TRAP_ACT_IN_SET_TURN)
	e5:SetProperty(EFFECT_FLAG_SET_AVAILABLE)
	e5:SetCondition(c62089826.actcon)
	c:RegisterEffect(e5)
end
...
function c62089826.cafilter(c)
	return c:IsFaceupEx() and c:IsCode(89631139)
end
function c62089826.actcon(e)
	return Duel.IsExistingMatchingCard(c62089826.cafilter,e:GetHandlerPlayer(),LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil)
end