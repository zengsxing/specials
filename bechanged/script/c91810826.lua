...
function c91810826.cfilter(c)
	return c:IsFaceup() and c:IsRace(RACE_WYRM) and c:IsAttribute(ATTRIBUTE_FIRE)
end
...
function c91810826.filter(c,e,tp)
	return c:IsRace(RACE_WYRM) and c:IsAttribute(ATTRIBUTE_FIRE) and c:IsLevelBelow(4) and not c:IsCode(91810826)
