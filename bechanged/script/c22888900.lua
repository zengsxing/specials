...
function c22888900.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(22888900,0))
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_TRAP_ACT_IN_HAND)
	e2:SetCondition(c22888900.handcon)
	c:RegisterEffect(e2)
end
function c22888900.handcon(e)
	return Duel.IsExistingMatchingCard(c22888900.cfilter,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil)
end
...
function c22888900.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c22888900.cfilter,tp,LOCATION_MZONE,LOCATION_MZONE,1,nil)
end
