...
function s.thfilter(c)
	return c:IsSSetable() and c:IsSetCard(0x2142,0x143)
end
...
function s.splimit(e,c)
	return not c:IsRace(RACE_ZOMBIE) and c:IsLocation(LOCATION_HAND+LOCATION_GRAVE)
end
