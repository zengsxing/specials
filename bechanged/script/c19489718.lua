...
function c19489718.initial_effect(c)
	...
	e3:SetCountLimit(1,19489718)
	e3:SetCost(c19489718.cpcost)
	e3:SetTarget(c19489718.cptg)
	e3:SetOperation(c19489718.cpop)
	c:RegisterEffect(e3)
end
function c19489718.cpfilter(c)
	return c:IsCode(99426088) and c:IsAbleToGraveAsCost()
		and c:CheckActivateEffect(true,true,false)~=nil
end
function c19489718.cpcost(e,tp,eg,ep,ev,re,r,rp,chk)
	e:SetLabel(1)
	if chk==0 then return not e:GetHandler():IsPublic() end
end
function c19489718.cptg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		if e:GetLabel()==0 then return false end
		e:SetLabel(0)
		return Duel.IsExistingMatchingCard(c19489718.cpfilter,tp,LOCATION_DECK,0,1,nil)
	end
	e:SetLabel(0)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_TOGRAVE)
	local g=Duel.SelectMatchingCard(tp,c19489718.cpfilter,tp,LOCATION_DECK,0,1,1,nil)
...
function c19489718.cpop(e,tp,eg,ep,ev,re,r,rp)
