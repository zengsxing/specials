...
function c50766506.cfilter(c,e,tp,ft)
	...
	return lv>0 and c:IsSetCard(0x2b)
		...
		and Duel.IsExistingMatchingCard(c50766506.spfilter,tp,LOCATION_DECK+LOCATION_HAND+LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil,lv,e,tp)
end
...
function c50766506.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local sg=Duel.GetMatchingGroup(aux.NecroValleyFilter(c50766506.spfilter),tp,LOCATION_DECK+LOCATION_HAND+LOCATION_GRAVE+LOCATION_REMOVED,0,nil,slv,e,tp)
