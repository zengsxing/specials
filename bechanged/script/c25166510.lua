...
function c25166510.cfilter(c)
	return c:IsSetCard(0x119) and c:IsType(TYPE_MONSTER) and c:IsFaceupEx()
end
function c25166510.cfilter1(c,tp)
	return c:IsSetCard(0x119) and c:IsType(TYPE_MONSTER) and c:IsFaceupEx()
		and Duel.IsExistingMatchingCard(c25166510.cfilter2,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,c,c)
end
function c25166510.cfilter2(c,tc)
	return c:IsSetCard(0x119) and c:IsType(TYPE_MONSTER) and c:IsFaceupEx() and c:IsCode(tc:GetCode())
end
function c25166510.spcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c25166510.cfilter,tp,LOCATION_GRAVE+LOCATION_MZONE,0,3,nil)
		or Duel.IsExistingMatchingCard(c25166510.cfilter1,tp,LOCATION_GRAVE+LOCATION_MZONE,0,1,nil,tp)
end
