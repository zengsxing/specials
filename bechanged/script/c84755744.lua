...
function s.initial_effect(c)
	...
	e4:SetCondition(c84755744.condition)
	e4:SetTarget(c84755744.target)
	e4:SetOperation(c84755744.operation)
	c:RegisterEffect(e4)
end
function c84755744.condition(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsLocation(LOCATION_GRAVE) and r==REASON_SYNCHRO
end
function c84755744.filter(c)
	return c:IsSetCard(0x119) and c:IsAbleToHand()
end
function c84755744.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c84755744.filter,tp,LOCATION_DECK,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
function c84755744.operation(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c84755744.filter,tp,LOCATION_DECK,0,1,1,nil)
