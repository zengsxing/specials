...
function c365213.initial_effect(c)
	aux.AddCodeList(c,44508094,21159309,70902743)
	--to deck
	...
	e4:SetCondition(c365213.imcon)
	e4:SetValue(c365213.efilter)
	c:RegisterEffect(e4)
end
...
function c365213.tdlimit(e,c)
	return (c:IsCode(44508094,70902743) or c:IsType(TYPE_SYNCHRO) and (aux.IsCodeListed(c,44508094) or aux.IsCodeListed(c,70902743))) and c:IsOnField()
end
...
function c365213.imcon(e)
	return Duel.IsExistingMatchingCard(aux.AND(Card.IsFaceupEx,Card.IsCode),e:GetHandlerPlayer(),LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil,21159309)
end
function c365213.efilter(e,te)
