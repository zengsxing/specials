...
function c95471006.initial_effect(c)
	aux.AddCodeList(c,70860415,6355563,33744268)
	--Activate
...
function c95471006.spfilter(c,e,tp)
	return c:IsCode(70860415,6355563,33744268) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function c95471006.sprfilter(c,e,tp)
	return c:IsCode(70860415,6355563,33744268) and c:IsFaceup() and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
