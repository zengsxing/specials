...
function c21123811.initial_effect(c)
	...
	--synchro summon
	aux.AddSynchroMixProcedure(c,c21123811.sfilter1,nil,nil,c21123811.sfilter2,1,99,c21123811.syncheck)
	c:EnableReviveLimit()
...
function c21123811.syncheck(g)
	return g:IsExists(c21123811.mgcheck,1,nil,g)
end
