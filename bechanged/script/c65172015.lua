...
function c65172015.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddFusionProcCode2(c,1561110,75748977,true,true)
...
function c65172015.spcon(e,c)
	...
	local g=Duel.GetMatchingGroup(c65172015.matfilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,0,nil,c)
...
function c65172015.spfilter3(c,e,tp)
	return c:IsFaceup() and c:IsCode(75748977) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
