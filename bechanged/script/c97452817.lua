...
function c97452817.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(97452817,1))
	e4:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e4:SetType(EFFECT_TYPE_IGNITION)
	e4:SetRange(LOCATION_GRAVE)
	e4:SetCountLimit(1,97452817)
	e4:SetCondition(c97452817.spcon)
	e4:SetTarget(c97452817.sptg)
	e4:SetOperation(c97452817.spop)
	c:RegisterEffect(e4)
end
