...
function c19642774.initial_effect(c)
	...
	e2:SetCountLimit(1,19642774)
	e2:SetValue(c19642774.matval)
	c:RegisterEffect(e2)
end
...
function c19642774.matval(e,c)
	return c:IsType(TYPE_SYNCHRO) and (c:IsCode(45037489) or c:IsRace(RACE_PLANT))
end