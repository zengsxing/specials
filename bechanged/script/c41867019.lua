...
function c41867019.initial_effect(c)
	...
	e1:SetCondition(function (e,tp,eg,ep,ev,re,r,rp)
		return (not Duel.IsExistingMatchingCard(function (c) return not c:IsRace(RACE_ZOMBIE) and c:IsType(TYPE_MONSTER) end,tp,LOCATION_GRAVE,0,1,nil) and e:GetHandler():IsLocation(LOCATION_HAND)) or not e:GetHandler():IsLocation(LOCATION_HAND)
		end)
	c:RegisterEffect(e1)
	--choose effect
