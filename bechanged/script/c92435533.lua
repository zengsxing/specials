...
function c92435533.initial_effect(c)
	...
	e8:SetDescription(aux.Stringid(92435533,1))
	e8:SetCategory(CATEGORY_TODECK+CATEGORY_SEARCH+CATEGORY_TOHAND)
...
function c92435533.rtdop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsRelateToEffect(e) and Duel.SendtoDeck(c,nil,SEQ_DECKSHUFFLE,REASON_EFFECT)~=0
		...
		and Duel.IsExistingMatchingCard(c92435533.thfilter,tp,LOCATION_DECK,0,1,nil) then
		Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
		local g=Duel.SelectMatchingCard(tp,c92435533.thfilter,tp,LOCATION_DECK,0,1,1,nil)
