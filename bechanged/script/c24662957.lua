...
function c24662957.initial_effect(c)
	...
	e2:SetDescription(aux.Stringid(24662957,1))
	e2:SetType(EFFECT_TYPE_SINGLE)
	e2:SetCode(EFFECT_TRAP_ACT_IN_HAND)
	e2:SetCountLimit(1,24662957)
	e2:SetCondition(c24662957.handcon)
	c:RegisterEffect(e2)
end
...
function c24662957.handcon(e)
	return Duel.GetFieldGroupCount(e:GetHandlerPlayer(),LOCATION_MZONE,0)==0 or Duel.IsExistingMatchingCard(Card.IsSetCard,e:GetHandlerPlayer(),LOCATION_MZONE,0,1,nil,0x1045)
end