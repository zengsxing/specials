...
function c95676943.condition(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetCurrentPhase()==PHASE_MAIN1 or Duel.GetCurrentPhase()==PHASE_MAIN2 and ((e:GetHandler():IsLocation(LOCATION_HAND) and Duel.GetFieldGroupCount(tp,0,LOCATION_ONFIELD)>0) or not e:GetHandler():IsLocation(LOCATION_HAND))
end
