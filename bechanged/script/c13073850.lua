...
function c13073850.initial_effect(c)
	...
	e10:SetCondition(c13073850.pzcon)
	e10:SetTarget(c13073850.pztg)
	e10:SetOperation(c13073850.pzop)
...
function c13073850.pzfilter(c)
	return c:IsSetCard(0xaa)
end
function c13073850.pzcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c13073850.pzfilter,tp,LOCATION_PZONE,0,2,nil)
end
function c13073850.pztg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLocation(1-tp,LOCATION_PZONE,0) or Duel.CheckLocation(1-tp,LOCATION_PZONE,1) end
end
function c13073850.pzop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
