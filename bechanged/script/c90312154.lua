...
function c90312154.initial_effect(c)
	...
	e1:SetCondition(function (e)
		...
		return ((e:GetHandler():IsLocation(LOCATION_HAND) and Duel.GetFieldGroupCount(tp,LOCATION_FZONE,LOCATION_FZONE)==0) or not e:GetHandler():IsLocation(LOCATION_HAND))
	end)
