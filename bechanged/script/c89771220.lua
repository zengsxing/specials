...
function c89771220.initial_effect(c)
	aux.AddCodeList(c,89264428,58793369,97148796,29537493,33250142)
	--urfield,dryfield,dryalpha,urwhite,ship
	--Activate
...
function c89771220.deckconfilter(c)
	return c:IsCode(97148796,29537493) and c:IsFaceup()--already altered
end
...
function c89771220.fselect(g,e,tp)
	return g:GetClassCount(Card.GetCode)==2 and g:FilterCount(Card.IsLocation,nil,LOCATION_DECK)<=2 --altered to 2 here
