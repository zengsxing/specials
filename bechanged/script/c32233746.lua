...
function c32233746.initial_effect(c)
	...
	e4:SetCondition(c32233746.setcon)
	e4:SetTarget(c32233746.settg)
	e4:SetOperation(c32233746.setop)
	c:RegisterEffect(e4)
end
function c32233746.setcon(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():IsPreviousLocation(LOCATION_DECK)
end
function c32233746.settg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return e:GetHandler():IsSSetable() end
	Duel.SetOperationInfo(0,CATEGORY_LEAVE_GRAVE,e:GetHandler(),1,0,0)
end
function c32233746.setop(e,tp,eg,ep,ev,re,r,rp)
