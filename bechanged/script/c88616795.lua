...
function c88616795.target(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	local opt=Duel.SelectOption(tp,aux.Stringid(88616795,0),aux.Stringid(88616795,1),aux.Stringid(88616795,2))
	e:SetLabel(opt)
end
function c88616795.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsRelateToEffect(e) and tc:IsFaceup() then
		...
		elseif e:GetLabel()==1 then 
			...
			e2:SetValue(c88616795.efilter3)
		end
...
function c88616795.efilter3(e,te)
