...
function c56655675.initial_effect(c)
	...
	aux.AddContactFusionProcedure(c,c56655675.cfilter,LOCATION_MZONE+LOCATION_HAND+LOCATION_GRAVE,0,Duel.Remove,POS_FACEUP,REASON_COST):SetValue(SUMMON_VALUE_SELF)
	--spsummon condition
