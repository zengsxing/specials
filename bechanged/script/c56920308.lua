...
function c56920308.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(56920308,4))
	e5:SetType(EFFECT_TYPE_SINGLE)
	e5:SetCode(EFFECT_TRAP_ACT_IN_SET_TURN)
	e5:SetProperty(EFFECT_FLAG_SET_AVAILABLE)
	e5:SetCondition(c56920308.actcon)
	c:RegisterEffect(e5)
end
...
function c56920308.cafilter(c)
	return c:IsFaceup() and c:IsCode(89631139)
end
function c56920308.actcon(e)
	return Duel.IsExistingMatchingCard(c56920308.cafilter,e:GetHandlerPlayer(),LOCATION_ONFIELD,0,1,nil)
end