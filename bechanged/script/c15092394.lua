...
function c15092394.initial_effect(c)
	c:EnableReviveLimit()
	aux.AddXyzProcedure(c,nil,5,2,c15092394.ovfilter,aux.Stringid(15092394,0),2,c15092394.xyzop)
	--destroy
...
function c15092394.ovfilter(c)
	return c:IsFaceup() and c:GetRank()==4 and c:IsSetCard(0xba)
end
function c15092394.xyzop(e,tp,chk)
	if chk==0 then return Duel.GetFlagEffect(tp,15092394)==0 end
	Duel.RegisterFlagEffect(tp,15092394,RESET_PHASE+PHASE_END,EFFECT_FLAG_OATH,1)
end
