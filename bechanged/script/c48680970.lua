...
function c48680970.initial_effect(c)
	...
	e5:SetDescription(aux.Stringid(48680970,4))
	e5:SetType(EFFECT_TYPE_SINGLE)
	e5:SetCode(EFFECT_TRAP_ACT_IN_SET_TURN)
	e5:SetProperty(EFFECT_FLAG_SET_AVAILABLE)
	e5:SetCondition(c48680970.actcon)
	c:RegisterEffect(e5)
end
...
function c48680970.cafilter(c)
	return c:IsFaceupEx() and c:IsCode(46986414)
end
function c48680970.actcon(e)
	return Duel.IsExistingMatchingCard(c48680970.cafilter,e:GetHandlerPlayer(),LOCATION_ONFIELD+LOCATION_GRAVE,0,1,nil)
end