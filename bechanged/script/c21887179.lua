...
function c21887179.initial_effect(c)
	...
	e3:SetCondition(c21887179.discon)
	e3:SetTarget(c21887179.distg)
	e3:SetOperation(c21887179.disop)
	c:RegisterEffect(e3)
end
...
function c21887179.discon(e,tp,eg,ep,ev,re,r,rp)
...
function c21887179.distg(e,tp,eg,ep,ev,re,r,rp,chk)
...
function c21887179.disop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if not c:IsRelateToEffect(e) then return end
	if c:IsPublic() then return end
	local fid=c:GetFieldID()
	c:RegisterFlagEffect(21887179,RESET_EVENT+RESETS_STANDARD+RESET_PHASE+PHASE_END,EFFECT_FLAG_CLIENT_HINT,1,fid,66)
	local e1=Effect.CreateEffect(c)
