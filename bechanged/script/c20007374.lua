...
function c20007374.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return g:GetClassCount(Card.GetCode)>=5 and ((Duel.GetTurnPlayer()==tp and (ph>=PHASE_BATTLE_START and ph<=PHASE_BATTLE) and e:GetHandler():IsLocation(LOCATION_HAND)) or not e:GetHandler():IsLocation(LOCATION_HAND))
end
