...
function s.setfilter(c)
	return c:IsSetCard(0x2c7) and c:IsType(TYPE_SPELL+TYPE_TRAP) and c:IsSSetable()
end
...
function s.spfilter(c,e,tp)
	return c:IsSetCard(0x2c7) and not c:IsType(TYPE_FUSION) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
