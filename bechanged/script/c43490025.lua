...
function c43490025.initial_effect(c)
	aux.EnableChangeCode(c,52653092,LOCATION_MZONE+LOCATION_GRAVE)
	--xyz summon
	c:EnableReviveLimit()
...
function c43490025.atkval(e,c)
	...
	return Duel.GetMatchingGroupCount(c43490025.atkfilter,c:GetControler(),LOCATION_GRAVE,LOCATION_GRAVE,nil)*500+g:GetSum(Card.GetRank)*500
end
