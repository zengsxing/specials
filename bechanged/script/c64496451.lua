...
function c64496451.initial_effect(c)
	...
	e10:SetCondition(c64496451.pzcon)
	e10:SetTarget(c64496451.pztg)
	e10:SetOperation(c64496451.pzop)
...
function c64496451.pzfilter(c)
	return c:IsSetCard(0xaa)
end
function c64496451.pzcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c64496451.pzfilter,tp,LOCATION_PZONE,0,2,nil)
end
function c64496451.pztg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.CheckLocation(1-tp,LOCATION_PZONE,0) or Duel.CheckLocation(1-tp,LOCATION_PZONE,1) end
end
function c64496451.pzop(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
