...
function c94432298.initial_effect(c)
	...
	e1:SetCondition(function (e)
		...
		return ((e:GetHandler():IsLocation(LOCATION_HAND) and Duel.GetFieldGroup(tp,LOCATION_ONFIELD,0):IsExists(function(tc)
			return (tc:IsSetCard(0xc5) or tc:IsSetCard(0xbb)) and tc:IsFaceup()
