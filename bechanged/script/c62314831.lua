...
function s.confilter(c)
	return c:IsFaceupEx() and c:IsCode(56099748)
end
function s.accon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(s.confilter,tp,LOCATION_ONFIELD+LOCATION_GRAVE,LOCATION_ONFIELD+LOCATION_GRAVE,1,nil)
end
...
function s.cpfilter(c)
	return (c:IsType(TYPE_SPELL) or c:GetType()==TYPE_SPELL or c:GetType()==TYPE_TRAP) and aux.IsCodeListed(c,56099748) and c:IsAbleToGraveAsCost()
