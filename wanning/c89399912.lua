...
function c89399912.hspcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetFlagEffect(tp,13513663)>0 and Duel.GetFlagEffect(tp,89399912)==0
    local b=Duel.GetFlagEffect(tp,13513663)==0 and Duel.GetFlagEffect(tp,89399912)==0 and Duel.GetFlagEffect(tp,89399913)==0  and Duel.GetFlagEffect(tp,89399914)==0 and Duel.GetFlagEffect(tp,89399915)==0  
	if chk==0 then return (a or b) and Duel.IsExistingMatchingCard(c89399912.rfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,2,e:GetHandler()) end
...
function c89399912.rettg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    Duel.RegisterFlagEffect(tp,89399913,RESET_PHASE+PHASE_END,0,1)
...
function c89399912.shcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetFlagEffect(tp,13513663)>0 and Duel.GetFlagEffect(tp,89399914)==0
    local b=Duel.GetFlagEffect(tp,13513663)==0 and Duel.GetFlagEffect(tp,89399912)==0 and Duel.GetFlagEffect(tp,89399913)==0  and Duel.GetFlagEffect(tp,89399914)==0 and Duel.GetFlagEffect(tp,89399915)==0  
    ...
    Duel.RegisterFlagEffect(tp,89399914,RESET_PHASE+PHASE_END,0,1)
...
function c89399912.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
    ...
    local b=Duel.GetFlagEffect(tp,13513663)==0 and Duel.GetFlagEffect(tp,89399912)==0 and Duel.GetFlagEffect(tp,89399913)==0  and Duel.GetFlagEffect(tp,89399914)==0 and Duel.GetFlagEffect(tp,89399915)==0  
	if chk==0 then return (a or b) and Duel.IsExistingMatchingCard(c89399912.thfilter,tp,LOCATION_DECK,0,1,nil) end
    Duel.RegisterFlagEffect(tp,89399915,RESET_PHASE+PHASE_END,0,1)
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK)
end
