...
function c53804307.hspcost(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetFlagEffect(tp,13513663)>0 and Duel.GetFlagEffect(tp,53804307)==0
    local b=Duel.GetFlagEffect(tp,13513663)==0 and Duel.GetFlagEffect(tp,53804307)==0 and Duel.GetFlagEffect(tp,53804308)==0  and Duel.GetFlagEffect(tp,53804309)==0 and Duel.GetFlagEffect(tp,53804310)==0  
	if chk==0 then return (a or b) and Duel.IsExistingMatchingCard(c53804307.rfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,2,e:GetHandler()) end
...
function c53804307.rettg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.RegisterFlagEffect(tp,53804308,RESET_PHASE+PHASE_END,0,1)
...
function c53804307.descost(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetFlagEffect(tp,13513663)>0 and Duel.GetFlagEffect(tp,53804309)==0
    local b=Duel.GetFlagEffect(tp,13513663)==0 and Duel.GetFlagEffect(tp,53804307)==0 and Duel.GetFlagEffect(tp,53804308)==0  and Duel.GetFlagEffect(tp,53804309)==0 and Duel.GetFlagEffect(tp,53804310)==0  
	if chk==0 then return (a or b) and e:GetHandler():IsDiscardable() and e:GetHandler():IsAbleToGraveAsCost()
	...
	Duel.RegisterFlagEffect(tp,53804309,RESET_PHASE+PHASE_END,0,1)
end
...
function c53804307.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	local a=Duel.GetFlagEffect(tp,13513663)>0
    local b=Duel.GetFlagEffect(tp,13513663)==0 and Duel.GetFlagEffect(tp,53804307)==0 and Duel.GetFlagEffect(tp,53804308)==0  and Duel.GetFlagEffect(tp,53804309)==0 and Duel.GetFlagEffect(tp,53804310)==0  
	if chk==0 then return (a or b) and Duel.IsExistingMatchingCard(c53804307.thfilter,tp,LOCATION_DECK,0,1,nil) end
	Duel.RegisterFlagEffect(tp,53804310,RESET_PHASE+PHASE_END,0,1)
