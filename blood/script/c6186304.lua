...
function c6186304.initial_effect(c)
	...
	e2:SetTargetRange(1,0)
	e2:SetCondition(c6186304.skipcon2)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
	e3:SetCode(EFFECT_DRAW_COUNT)
	e3:SetValue(0)
	...
	e4:SetTargetRange(LOCATION_ONFIELD,0)
	e4:SetCondition(c6186304.condition2)
	e4:SetValue(aux.tgoval)
	c:RegisterEffect(e4)
	--atkup
	...
	e5:SetTargetRange(LOCATION_MZONE,0)
	e5:SetCondition(c6186304.condition2)
	e5:SetTarget(aux.TargetBoolFunction(Card.IsCode,83965310))
	e5:SetValue(c6186304.atkval)
	c:RegisterEffect(e5)
	local e6=e5:Clone()
...
function c6186304.condition2(e)
	local tp=e:GetHandlerPlayer()
	return Duel.IsPlayerAffectedByEffect(tp,83965310)
end
function c6186304.skipcon(e)
	return c6186304.condition(e) and Duel.GetCurrentPhase()==PHASE_DRAW
end
function c6186304.skipcon2(e)
	return c6186304.condition(e) and c6186304.condition2(e) and Duel.GetCurrentPhase()==PHASE_DRAW
end
