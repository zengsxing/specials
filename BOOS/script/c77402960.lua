...
function c77402960.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c77402960.spfilter,tp,LOCATION_EXTRA,0,4,nil,e,tp)
		and Duel.GetLocationCountFromEx(tp,tp,nil,TYPE_XYZ)>3 end
...
function c77402960.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if ect>0 and (ft1>0 or ft2>0) then
		...
		if sg:GetCount()>0 then
			...
			local rg=sg:SelectSubGroup(tp,c77402960.fselect,false,4,4,ft1,ft2,ect,ft)
