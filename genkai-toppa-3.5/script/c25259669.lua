...
function c25259669.sumtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsExistingMatchingCard(c25259669.filter,tp,LOCATION_HAND,0,2,nil,e,tp) end
...
function c25259669.sumop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.GetLocationCount(tp,LOCATION_MZONE)>0 then
		...
		local g=Duel.SelectMatchingCard(tp,c25259669.filter,tp,LOCATION_HAND,0,2,2,nil,e,tp)
