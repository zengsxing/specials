...
function s.mttg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ct>0 and e:GetHandler():IsType(TYPE_XYZ)
		and Duel.CheckRemoveOverlayCard(tp,1,0,2,REASON_EFFECT)
...
function s.mtop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.RemoveOverlayCard(tp,1,0,2,2,REASON_EFFECT)==0 then return end
...
function s.tgtg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return ct>0 and Duel.CheckRemoveOverlayCard(tp,1,0,6,REASON_EFFECT)
...
function s.tgop(e,tp,eg,ep,ev,re,r,rp)
	if Duel.RemoveOverlayCard(tp,1,0,6,6,REASON_EFFECT)==0 then return end
	local g=Duel.GetChainInfo(0,CHAININFO_TARGET_CARDS)
